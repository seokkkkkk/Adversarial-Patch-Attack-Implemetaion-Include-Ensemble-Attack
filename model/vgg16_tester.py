...
test_patch = patch.patch_init(64, "default", device, "C:\\Users\\HOME\\IdeaProjects\\adversarial_patch\\model\\patch\\best_patch_9_0.0468.png")
...
for images in test_loader:
    for image in images:
        ...
        results = model(patched_image)

        top1_class = torch.argmax(results, dim=1).item()
